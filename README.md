...
​Features Used: Pivot Tables, Pivot Charts, Slicers, Advanced Formulas (IF, VLOOKUP), Conditional Formatting.# Bike-Sales-Dashboard
Created a dashboard from a bike sales data using Excel
